...
Inbox Notification webhooks are recorded as daemon audit events. If Linear notifies Tetherbox that the app user was unassigned from an issue, matching active local jobs are canceled.
