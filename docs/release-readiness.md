...
| Linear Agent Session polling reaches Tetherbox | `OSS-293` reached the live Tetherbox daemon through the Linear Agent Session polling fallback and started job `413bf36d-cf67-4067-a45a-50f99849438d-70106d54` without a manual signed replay. Native webhook delivery still needs Linear-side configuration review. | Smoke passed |
